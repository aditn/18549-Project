...
meas_upper_weight = sb_l1 + sb_r1 + st + bl + bu
...
if sb_l1 < sb_r1 * (1-acceptable_range) or sb_l1 > sb_r1 * (1+acceptable_range) or meas_upper_weight_perc < std_upper_weight_perc - acceptable_range or meas_upper_weight_perc > meas_upper_weight_perc + acceptable_range or st < 50 or bl < 50 or bu < 50:
    correct_posture = 0
